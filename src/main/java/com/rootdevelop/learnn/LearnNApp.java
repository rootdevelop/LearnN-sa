package com.rootdevelop.learnn;
...
public class LearnNApp {

    private static final Logger log = LoggerFactory.getLogger(LearnNApp.class);

    private final Environment env;

    public LearnNApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(LearnNApp.class);
